  ...
  return (
    <div className="animate-fade-in">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h1 className="text-xl font-bold">Mavzular</h1>
          <p className="text-sm text-gray-500">15 ta mavzu, har birida 13 ta topshiriq</p>
        </div>
      </div>
      ...
      {!isAuthenticated && (
        <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 mb-6 flex items-center gap-3">
          ...
          <p className="text-sm text-amber-800">
            Mavzularga kirish uchun <Link to="/login" className="font-semibold text-amber-900 underline">tizimga kiring</Link>
          </p>
        </div>
      )}
        ...
        {units.map(unit => {
          ...
          return (
            <Link
              ...
              className="card flex items-center gap-4 hover:border-blue-300"
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-3 mt-1.5">
                  ...
                  <span className="text-xs text-gray-500 whitespace-nowrap">
                    {unit.completed_count}/{unit.tasks_count} topshiriq
                  </span>
                </div>
              </div>
